...
def copy_test_initializer(path)
  source = "#{__dir__}/spec/fixtures/helsinki_profile_initializer.rb"
  FileUtils.cp(source, "#{Dir.pwd}/#{path}/config/initializers/helsinki_profile.rb")
end
